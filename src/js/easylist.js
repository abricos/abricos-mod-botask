...
Component.entryPoint = function(NS){
	...
	var TaskListBoxWidget = function(container, list, config){
		config = L.merge({
			...
			'boxtitle': '',
			'countlabeltext': '',
			'funcfilter': function(){ return false; }
		}, config || {});
	...
	YAHOO.extend(TaskListBoxWidget, NS.TaskTableWidget, {
		...
		isRenderChild: function(tk){ return false; },
		isChildExpanded: function(tk){ return null; },
		...
		render: function(){
			...
			var TM = this._TM,
				gel = function(nm){ return TM.getEl('boxitem.'+nm); };
	...
	EasyListWidget.prototype = {
		init: function(container, contFavorite){
			...
			var TM = this._TM,
				gel = function(name){ return TM.getEl('widget.'+name); };
